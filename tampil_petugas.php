  ...
  <tbody>
    ...
    while ($dt_petugas = mysqli_fetch_array($query_petugas)){?>
        <tr> 
            ...
            <td>
              <a href="ubah_petugas.php?id_petugas=<?=$dt_petugas['id_petugas']?>" class="btn btn-primary">Ubah</a>
    ...
    <br><a href="tambah_petugas.php?id_petugas=<?=$dt_petugas['id_petugas']?>" class="btn btn-success">Tambah</a></br>
